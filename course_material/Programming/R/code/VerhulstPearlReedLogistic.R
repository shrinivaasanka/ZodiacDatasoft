...
verhulstpearlreedlaw <- function(filename, lambdaVPR, lambdaMay, initialcondition)
{
  print(filename)
  ...
  corrcoeff21 <- cor.test(coronavirus2019scaled,rev(maylogistic),method="kendall",alternative="greater")
  print(corrcoeff21)
  corrcoeff22 <- cor.test(coronavirus2019scaled,rev(maylogistic),method="spearman",alternative="greater")
  print(corrcoeff22)
  corrcoeff23 <- cor.test(coronavirus2019scaled,rev(maylogistic),method="pearson",alternative="greater")
  print(corrcoeff23)
